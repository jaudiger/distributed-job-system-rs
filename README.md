...
This project consists of two Rust applications (client and server) that work together with MongoDB, Kafka, Prometheus, and Jaeger to provide a distributed job processing system. This system processes mathematical operations that are sent to a HTTP endpoint.
