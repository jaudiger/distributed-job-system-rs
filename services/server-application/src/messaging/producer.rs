...
impl MessageProducer {
    ...
    pub const KAFKA_CONFIG_ACKS: &str = "acks";
    pub const KAFKA_CONFIG_BATCH_SIZE: &str = "batch.size";
    pub const KAFKA_CONFIG_BOOTSTRAP_SERVERS: &str = "bootstrap.servers";
    pub const KAFKA_CONFIG_COMPRESSION_TYPE: &str = "compression.type";
    pub const KAFKA_CONFIG_LINGER_MS: &str = "linger.ms";

    pub const KAFKA_CONFIG_ACKS_DEFAULT_VALUE: &str = "1";
    pub const KAFKA_CONFIG_BATCH_SIZE_DEFAULT_VALUE: &str = "16384";
    pub const KAFKA_CONFIG_COMPRESSION_TYPE_DEFAULT_VALUE: &str = "zstd";
    pub const KAFKA_CONFIG_LINGER_MS_DEFAULT_VALUE: &str = "50";
            ...
            async move {
                ...
                async {
                    ...
                    let operation_result =
                        match serde_json::to_string(&OperationResult::from(operation)) {
                            Ok(payload) => payload,
                            Err(err) => {
                                tracing::error!("Failed to serialize operation result: {err}");
